...
final kTestSqliteMigrations = [
  ...
  Migration(
    statements: [
      ...
      "INSERT INTO _electric_trigger_settings(namespace,tablename,flag) VALUES ('main', 'blobTable', 1);",
      ...
      'DROP TRIGGER IF EXISTS update_ensure_main_blobTable_primarykey;',
      "CREATE TRIGGER update_ensure_main_blobTable_primarykey\n   BEFORE UPDATE ON main.blobTable\nBEGIN\n  SELECT\n    CASE\n      WHEN old.value != new.value THEN\n        RAISE (ABORT,'cannot change the value of column value as it belongs to the primary key')\n    END;\nEND;",
      'DROP TRIGGER IF EXISTS insert_main_blobTable_into_oplog;',
      ...
      'DROP TRIGGER IF EXISTS update_main_blobTable_into_oplog;',
      ...
      'DROP TRIGGER IF EXISTS delete_main_blobTable_into_oplog;',
