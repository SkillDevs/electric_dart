...
///
/// [extending] is a [Reference] to the parent type of the data class generated by drift. The [Reference] type comes from the package [`code_builder`](https://pub.dev/packages/code_builder).
...
///
/// [type] A [Reference] to the custom row class. The [Reference] type comes from the package [`code_builder`](https://pub.dev/packages/code_builder).
///
