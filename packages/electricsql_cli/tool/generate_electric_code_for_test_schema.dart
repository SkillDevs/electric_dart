...
Future<void> main() async {
  final prismaSchemaFile =
      File(join(projectDir.path, 'test/client/drift/schema.prisma'));
  ...
  final driftSchemaFile = File(
    join(
      projectDir.path,
      'test/client/drift/generated/electric/drift_schema.dart',
    ),
  );
