...
const kSqliteMigrations = <Migration>[
  ...
  Migration(
    statements: [
      ...
      'CREATE TRIGGER insert_main_todo_into_oplog\n  AFTER INSERT ON "main"."todo"\n  WHEN 1 = (SELECT flag from _electric_trigger_settings WHERE namespace = \'main\' AND tablename = \'todo\')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES (\'main\', \'todo\', \'INSERT\', json_patch(\'{}\', json_object(\'id\', new."id")), json_object(\'completed\', new."completed", \'created_at\', new."created_at", \'edited_at\', new."edited_at", \'id\', new."id", \'listid\', new."listid", \'text\', new."text"), NULL, NULL);\nEND;',
      'DROP TRIGGER IF EXISTS update_main_todo_into_oplog;',
      'CREATE TRIGGER update_main_todo_into_oplog\n  AFTER UPDATE ON "main"."todo"\n  WHEN 1 = (SELECT flag from _electric_trigger_settings WHERE namespace = \'main\' AND tablename = \'todo\')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES (\'main\', \'todo\', \'UPDATE\', json_patch(\'{}\', json_object(\'id\', new."id")), json_object(\'completed\', new."completed", \'created_at\', new."created_at", \'edited_at\', new."edited_at", \'id\', new."id", \'listid\', new."listid", \'text\', new."text"), json_object(\'completed\', old."completed", \'created_at\', old."created_at", \'edited_at\', old."edited_at", \'id\', old."id", \'listid\', old."listid", \'text\', old."text"), NULL);\nEND;',
      'DROP TRIGGER IF EXISTS delete_main_todo_into_oplog;',
      'CREATE TRIGGER delete_main_todo_into_oplog\n  AFTER DELETE ON "main"."todo"\n  WHEN 1 = (SELECT flag from _electric_trigger_settings WHERE namespace = \'main\' AND tablename = \'todo\')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES (\'main\', \'todo\', \'DELETE\', json_patch(\'{}\', json_object(\'id\', old."id")), NULL, json_object(\'completed\', old."completed", \'created_at\', old."created_at", \'edited_at\', old."edited_at", \'id\', old."id", \'listid\', old."listid", \'text\', old."text"), NULL);\nEND;',
